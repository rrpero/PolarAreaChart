...
(function (win, doc, undefined)
{
    ...
    RG.DrawKey = function (obj, key, colors)
    {
        ...
        */
        ...
        if (prop['chart.key.interactive']) {
            ...
            if (!RGraph2.Drawing || !RGraph2.Drawing.Rect) {
            ...
            */
            if (!RGraph2.InstallWindowMousedownListener) {
            ...
            for (var i=0,len=obj.coords.key.length; i<len; i+=1) {
                ...
                (function (idx)
                {
                    ...
                    var rect = new RGraph2.Drawing.Rect(obj.id,value[0], value[1], prop['chart.key.position'] == 'gutter' ? value[2] : maxlen, value[3])
    ...
    */
    RGraph2.HTML.key =
    RGraph2.HTML.Key = function (id, prop)
    {
        ...
        */
        var str = '<table border="0" cellspacing="0" cellpadding="0" id="rgraph2_key_' + uid + '" style="display: inline;' + (function ()
            {
                var style = ''
        ...
        */
        ...
        return doc.getElementById('rgraph2_key_' + uid);
    };
