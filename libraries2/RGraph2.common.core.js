// version: 2018-02-24
    ...
    */
    ...
    RGraph2 = window.RGraph2 || {isRGraph: true};
...
(function (win, doc, undefined)
{
    ...
    */
    ...
    RG.Registry.store['__rgraph2_event_listeners__'] = []; // Used in the new system for tooltips
    RG.Background     = {};
    RG.background     = {};
    RG.objects        = [];
    RG.Resizing       = {};
    ...
    */
    ...
    RG.ISOLD  = RGraph2.ISIE6 || RGraph2.ISIE7 || RGraph2.ISIE8; // MUST be here
    ...
    */
    ...
    RG.Register = function (obj)
    {
        ...
        if (!obj.Get('chart.noregister')) {
            ...
            RGraph2.ObjectRegistry.Add(obj);
    ...
    */
    ...
    RG.Redraw = function ()
    {
        var objectRegistry = RGraph2.ObjectRegistry.objects.byCanvasID;
        ...
        for (var i=0,len=tags.length; i<len; ++i) {
            if (tags[i].__object__ && tags[i].__object__.isRGraph) {
                ...
                if (!tags[i].noclear) {
                    RGraph2.clear(tags[i], arguments[0] ? arguments[0] : null);
                }
            }
        }
...
/*
    ...
    RG.HideZoomedCanvas = function ()
    {
        ...
        if (prop['chart.zoom.fade.out']) {
            for (var i=frames,j=1; i>=0; --i, ++j) {
                if (typeof RG.zoom_image === 'object') {
                    setTimeout("RGraph2.zoom_image.style.opacity = " + String(i / 10), j * interval);
                }
            }

            if (typeof RG.zoom_background === 'object') {
                setTimeout("RGraph2.zoom_background.style.opacity = " + String(i / frames), j * interval);
            }
        }

        if (typeof RG.zoom_image === 'object') {
            setTimeout("RGraph2.zoom_image.style.display = 'none'", prop['chart.zoom.fade.out'] ? (frames * interval) + 10 : 0);
        }

        if (typeof RG.zoom_background === 'object') {
            setTimeout("RGraph2.zoom_background.style.display = 'none'", prop['chart.zoom.fade.out'] ? (frames * interval) + 10 : 0);
        }
    };
    ...
    */
    ...
    /**
    * Used to fire one of the RGraph2 custom events
    * 
    ...
    */
    RGraph2.removeAllCustomEventListeners =
    RGraph2.RemoveAllCustomEventListeners = function ()
    {
        var id = arguments[0];
    ...
    */
    ...
    RG.DrawBackgroundImage = function (obj)
    {
        ...
        if (typeof prop['chart.background.image'] === 'string') {
            if (typeof ca.__rgraph2_background_image__ === 'undefined') {
                var img = new Image();
                img.__object__  = obj;
                img.__canvas__  = ca;
                img.__context__ = co;
                ...
                ca.__rgraph2_background_image__ = img;
            } else {
                img = ca.__rgraph2_background_image__;
            }

            // When the image has loaded - redraw the canvas
            img.onload = function ()
            {
                obj.__rgraph2_background_image_loaded__ = true;
                RG.clear(ca);
                RG.redrawCanvas(ca);
            }
    ...
    */
    ...
    {
        var objects = RGraph2.ObjectRegistry.objects.byUID;
    ...
    RG.InstallEventListeners = function (obj)
    {
        ...
        */
        if (RG.installCanvasClickListener) {
            ...
            alert('[RGRAPH2] You appear to have used dynamic features but not included the file: RGraph.common.dynamic.js');
        }
    };
    ...
    */
    RG.pr = function (obj)
    {
        ...
        switch (typeof obj) {
            ...
            case 'object':
                // In case of null
                if (RGraph2.is_null(obj)) {
                    str += indent + 'null\n';
                } else {
                    str += indent + 'Object {' + '\n'
                    for (j in obj) {
                        str += indent + '    ' + j + ' => ' + RGraph2.pr(obj[j], true, indent + '    ', counter + 1) + '\n';
                    }
                    str += indent + '}';
                }
                break;
    ...
    */
    ...
    /**
    * Uses the above RGraph2.AJAX function but calls the call back passing an array as its argument.
    ...
    RG.Text2 = function (obj, opt)
    {
        ...
        */
        function domtext ()
        {
            ...
            */
            ...
            if (!ca.rgraph2_domtext_wrapper) {

                var wrapper = document.createElement('div');
                    wrapper.id        = ca.id + '_rgraph2_domtext_wrapper';
                    wrapper.className = 'rgraph2_domtext_wrapper';
                ...
                ca.rgraph2_domtext_wrapper = wrapper;
                
                // TODO Add a subwrapper here

            } else {
                wrapper = ca.rgraph2_domtext_wrapper;
            }
            ...
            * if it's an RGraph2 object that was given)
            */
        ...
        */
        if (obj && obj.isRGraph) {
            ...
            var co = ca.getContext('2d');
            var obj = ca.__object__;
        } else if (obj.toString().indexOf('CanvasRenderingContext2D') != -1 || RGraph2.ISIE8 && obj.moveTo) {
            var co  = obj;
            var ca  = obj.canvas;
            var obj = ca.__object__;
    ...
    */
    ...
    /**
    * Adds an event listener to RGraphs internal array so that RGraph2 can track them.
    ...
    */
    ...
    /**
    * Clears event listeners that have been installed by RGraph2
    * 
    ...
    */
    ...
    RG.ClearEventListeners = function(id)
    {
        if (id && id == 'window') {
            ...
            window.removeEventListener('mousedown', window.__rgraph2_mousedown_event_listener_installed__, false);
            window.removeEventListener('mouseup', window.__rgraph2_mouseup_event_listener_installed__, false);
        
        } else {
            
            var canvas = document.getElementById(id);
            
            canvas.removeEventListener('mouseup', canvas.__rgraph2_mouseup_event_listener_installed__, false);
            canvas.removeEventListener('mousemove', canvas.__rgraph2_mousemove_event_listener_installed__, false);
            canvas.removeEventListener('mousedown', canvas.__rgraph2_mousedown_event_listener_installed__, false);
            canvas.removeEventListener('click', canvas.__rgraph2_click_event_listener_installed__, false);
        }
    };
    ...
    */
    ...
    /**
    * Sets an object in the RGraph2 registry
    * 
    ...
    */
    ...
    /**
    * Gets an object from the RGraph2 registry
    * 
    ...
    */
    ...
    RG.Reset = function (ca)
    {
        ...
        ca.__rgraph2_aa_translated__ = false;
    ...
    * converts it to the RGraph2 stylee.
    * 
    ...
    * various options) on the RGraph2 blog (www.rgraph.net/blog). The function is
    ...
    */
    RG.path2 = function (co, p)
    {
        ...
        // Store the last path on the RGraph2 object
...
// End module pattern
    ...
    */
    window.$p = function (v)
    {
        RGraph2.pr(arguments[0], arguments[1], arguments[3]);
    };
