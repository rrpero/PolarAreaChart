...
(function (win, doc, undefined)
{
                ...
                for (var i=0; i<tags.length; ++i) {
                    if (tags[i].__object__ && tags[i].__object__.isRGraph) {
                        if (!tags[i].__object__.get('chart.annotatable')) {
                            if (!tags[i].__rgraph2_trace_cover__ && !noredraw) {
                                RG.clear(tags[i]);
                            } else {
                                var noredraw = true;
                            }
    ...
    * 
    * RGraph2.window_mouseup_event_listener
    */
    RG.installCanvasMouseupListener =
    RG.InstallCanvasMouseupListener = function (obj)
    {
        if (!obj.canvas.rgraph2_mouseup_event_listener) {
            obj.canvas.rgraph2_mouseup_event_listener = function (e)
            {
                /**
                * For firefox add the window.event object
                */
            ...
            obj.canvas.addEventListener('mouseup', obj.canvas.rgraph2_mouseup_event_listener, false);
        }
    };
    ...
    */
    ...
    {
        if (!obj.canvas.rgraph2_mousemove_event_listener) {
            obj.canvas.rgraph2_mousemove_event_listener = function (e)
            {
                    ...
                    for (var i=0,len=objects.length; i<len; i+=1) {
                        ...
                        */
                        if (shape && (typeof(func) == 'function' || typeof(func2) == 'function' || typeof obj.Get('link') === 'string')) {
                            ...
                            if (typeof(func)  == 'function')  RGraph2.custom_events_mousemove_pointer = func(e, shape);
                            if (typeof(func2) == 'function') RGraph2.custom_events_mousemove_pointer  = RGraph2.custom_events_mousemove_pointer || func2(e, shape);

                            // Go through the RGraph2.events array looking for more
                            // event listeners
                        ...
                        if (   shape
                            ...
                            RG.hideTooltip();
                            RG.redraw();
                            obj.canvas.rgraph2_mouseup_event_listener(e);
            ...
            obj.canvas.addEventListener('mousemove', obj.canvas.rgraph2_mousemove_event_listener, false);
        }
    };
    ...
    */
    ...
    {
        if (!obj.canvas.rgraph2_mousedown_event_listener) {
            obj.canvas.rgraph2_mousedown_event_listener = function (e)
            {
                /**
                * For firefox add the window.event object
                */
                        ...
                        */
                        ...
                        if (obj && obj.isRGraph) {
                            ...
                            if (
                                ...
                                obj.canvas.rgraph2_mousemove_event_listener(e);
                            }
                        }
                    }
            ...
            obj.canvas.addEventListener('mousedown', obj.canvas.rgraph2_mousedown_event_listener, false);
        }
    };
    ...
    */
    ...
    {
        if (!obj.canvas.rgraph2_click_event_listener) {
            obj.canvas.rgraph2_click_event_listener = function (e)
            {
                /**
                * For firefox add the window.event object
                */
            ...
            obj.canvas.addEventListener('click', obj.canvas.rgraph2_click_event_listener, false);
        }
    };
    ...
    */
    ...
    RG.EvaluateCursor = function (e)
    {
        ...
        */
        if (RGraph2.custom_events_mousemove_pointer) {
            var pointer = true;
            RGraph2.custom_events_mousemove_pointer = false;
        }
        /*
