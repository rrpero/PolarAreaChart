// version: 2018-02-24
    ...
    */
    ...
    RGraph2.Effects      = RGraph2.Effects || {};
    RGraph2.Effects.Rose = RGraph2.Effects.Rose || {};
    ...
    */
    RGraph2.Rose = function (conf)
    {
        ...
        */
        ...
        this.type              = 'rose';
        this.isRGraph          = true;
        this.uid               = RGraph2.CreateUID();
        this.canvas.uid        = this.canvas.uid ? this.canvas.uid : RGraph2.CreateUID();
        ...
        this.properties =
        {
            ...
            'chart.tooltips.css.class':     'RGraph2_tooltip',
        ...
        */
        var linear_data = RGraph2.arrayLinearize(this.data);
        ...
        * done already
        */
        if (!this.canvas.__rgraph2_aa_translated__) {
            this.context.translate(0.5,0.5);
            
            this.canvas.__rgraph2_aa_translated__ = true;
        }
        ...
        * 
        * RGraph2.ObjectRegistry.getObjectByXY(e)
        * 
        * @param object e The event object
        */
        this.getObjectByXY = function (e)
        {
            var mouseXY = RGraph2.getMouseXY(e);
